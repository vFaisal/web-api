...
export default class R2Service {
  public static readonly SUPPORTED_IMAGE_MIMETYPE = ["image/jpeg", "image/jpg", "image/png"];
  ...
  public get uri() {
    return `https://${this.config.getOrThrow("CLOUDFLARE_ACCOUNT_ID")}.r2.cloudflarestorage.com/${this.config.getOrThrow("CLOUDFLARE_R2_BUCKET_NAME")}`;
  }
