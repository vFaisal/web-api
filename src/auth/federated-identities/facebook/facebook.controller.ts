...
export class FacebookController {
  constructor(private readonly facebookService: FacebookService, private readonly csrfService: CSRFService, private readonly pkceService: PKCEService) {
  }
  ...
  async root(@Res() res, @Req() req) {
    ...
    res.redirect(this.facebookService.redirectAuthEndpointUrl(token, this.pkceService.enforcePKCE(res, req)));
  }
