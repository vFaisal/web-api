...
export class FederatedIdentitiesController {
  ...
  registration(@Body() body: FederatedRegistrationDto, @Req() req: FastifyRequest) {
    return this.federatedIdentitiesService.registration(body.signature, body.email, significantRequestInformation(req));
  }
}
